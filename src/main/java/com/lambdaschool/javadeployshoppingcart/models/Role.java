...
@Table(name = "roles")
public class Role
    extends com.lambdaschool.javadeployshoppingcart.models.Auditable
{
    /**
    ...
    @JsonIgnoreProperties(value = "role",
        allowSetters = true)
    private Set<com.lambdaschool.javadeployshoppingcart.models.UserRoles> users = new HashSet<>();
     ...
     */
    public Set<com.lambdaschool.javadeployshoppingcart.models.UserRoles> getUsers()
    {
        return users;
    }
     ...
     */
    public void setUsers(Set<com.lambdaschool.javadeployshoppingcart.models.UserRoles> users)
    {
        this.users = users;
    }
}
